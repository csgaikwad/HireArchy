...
function Testimonials() {
  ...
  return (
    <div className="pt-20 flex flex-col gap-4 md:px-[1rem] px-[1rem]">
      <div className="text-2xl titleT">What Our Users Say</div>
      <div className="relative w-full flex justify-center items-center">
        ...
        <div className="w-full h-full flex justify-center overflow-hidden bg-cyan-950 p-1">
          <div className="flex transition-transform duration-500 ease-in-out gap-3">
            {getVisibleTestimonials().map((testimonial, index) => (
              <div key={index} className="flex-shrink-0 w-full h-full md:w-1/3 p-2">
                <div className="w-full h-full p-4 bg-gray-900 rounded-md shadow-md">
