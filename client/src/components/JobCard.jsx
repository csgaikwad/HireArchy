            ...
            <Link to={`/details/${job._id}`} className='text-white flex flex-col gap-2  shadow-sm shadow-gray-800 border border-gray-700 md:px-4 px-3 w-full py-2'>
                ...
                <div className='flex gap-5 justify-around'>
                    <div className='flex justify-center items-center  '>
                        <img src={job.companyLogo.url} className=' w-[5rem]  ' alt="" />
                    </div>
                    <div className='flex flex-col '>
                        ...
                        <div className='flex justify-between gap-2 '>
                            <div className='flex flex-col gap-1'>
                                ...
                                <p className='text-sm md:flex hidden '>{job.description.slice(0, 80)}...</p>
                                <p className='text-sm flex md:hidden'>{job.description.slice(0, 40)}...</p>
                            </div>
                            <div className=' md:right-3 right-0 md:pt-0 top-3' >
