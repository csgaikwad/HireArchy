...
export const getAllJobsAdmin = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get("/api/v1/admin/allJobs", config);
...
export const getAllUsersAdmin = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get("/api/v1/admin/allUsers", config);
...
export const getAllAppAdmin = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get("/api/v1/admin/allApp", config);
...
export const getUserData = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`/api/v1/admin/getUser/${id}`, config);
...
export const getJobData = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`/api/v1/admin/getJob/${id}`, config);
