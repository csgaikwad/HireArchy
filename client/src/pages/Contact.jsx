      ...
      <div className="bg-gray-950 min-h-screen pt-14 md:px-20 px-3 text-white">
        <div className="flex flex-col gap-5 md:px-0 px-2 md:pt-8 pt-4 pb-20">
          ...
          <div>
            ...
            <Card
              title="Address"
              content="HireArchy, Wall Street, New York, 123, United States"
            />
            <Card
              title="Email"
              content={[
                "General Inquiries: info@HireArchy.com",
                "Support: support@HireArchy.com",
                "Job Applications: jobs@HireArchy.com",
              ]}
            />
            <Card
              title="Phone"
