        ...
        <div className="px-3 ">
          ...
          <div className="flex justify-start items-start gap-2">
            ...
            <p className="text-sm">
              ...
              that any false statements or omissions may result in
              disqualification from consideration or termination of application.
            </p>
          </div>
          <div className="pt-6 flex gap-3 pb-16">
            {loading ? (
              <button
                ...
                disabled={true}
                className={`md:px-14 px-12 py-2.5  blueCol2`}
              >
              ...
              <button
                onClick={makeApplication}
                disabled={!confirm}
                className={`md:px-10 px-8 py-2 ${
                  confirm ? "blueCol" : "blueCol2"
                }`}
              >
                Confirm{" "}
              </button>
